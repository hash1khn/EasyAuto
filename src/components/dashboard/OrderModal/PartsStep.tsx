...
export const PartsStep: React.FC<PartsStepProps> = ({
    ...
    const handleConditionChange = (conditions: string[]) => {
        setCurrentPart((prev) => ({
            ...prev,
            conditions: conditions as Part["conditions"],
        }));
    };
            ...
            <Card className="border-2 border-dashed border-gray-200 hover:border-primary/30 transition-colors">
                ...
                <CardContent className="space-y-4">
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setCurrentPart((prev) => ({
                                    ...prev,
                                    vehicleIndex: parseInt(e.target.value),
                                }))
                            }>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <Label htmlFor="estimatedBudget">
                                Max Budget (excluding VAT & service fee)
                            </Label>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                            <div className="space-y-1 text-center">
                                {currentPart.imageFiles?.length ? (
                                    <div className="grid grid-cols-3 gap-2 mb-4">
                                        {currentPart.imageFiles.map(
                                            (file, index) => (
                                                <div
                                                    key={index}
                                                    className="relative">
                    ...
                    <Button
                        ...
                        size="sm"
                        disabled={!currentPart.partName}>
                        <Plus className="w-4 h-4 mr-2" />
                        Add Part{" "}
                        {currentPart.imageFiles?.length > 0 &&
                                        ...
                                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center space-x-2 mb-1">
                                                    ...
                                                    <Badge
                                                        variant="outline"
                                                        className="bg-green-500/10 text-green-600 border-green-500/30 text-xs px-1.5 py-0.5">
                                                        {part.quantity}x
                                                    </Badge>
                                                    {part.estimatedBudget && (
                                                        <Badge
                                                            variant="outline"
                                                            className="bg-blue-500/10 text-blue-600 border-blue-500/30 text-xs px-1.5 py-0.5 flex items-center">
