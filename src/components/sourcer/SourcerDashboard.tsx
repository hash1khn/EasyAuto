...
const SourcerDashboard: React.FC = () => {
  ...
  const fetchLiveOrders = async () => {
    try {
      // Fetch parts with their related data, focusing on parts that are not yet delivered/completed
      ...
      `)
        .in("shipping_status", ["pending"]) // Focus on parts that are still being processed
        .not("is_accepted", "eq", true) // Only show parts that haven't been accepted yet
      ...
      partsData?.forEach((part) => {
        ...
        order.parts.push({
          ...
          vendorQuotes: part.bids.map((bid) => ({
            id: bid.id,
            vendorName: bid.vendor_info?.name || "Unknown Vendor",
            vendorAddress: bid.vendor_info?.address || "No address provided",
            vendorPhone: bid.vendor_info?.phone || "No phone provided",
            vendorEmail: bid.vendor_info?.email || "No email provided",
            price: bid.price,
            ...
            isSourcerProvided: bid.is_sourcer_provided,
            status: bid.status,
          })),
        })
      })
  ...
  const getFilteredParts = () => {
    const allPartsWithOrder: Array<{ order: Order; part: Part & { vehicle: Vehicle } }> = []
            ...
            <div className="flex justify-between items-start p-6 border-b">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  {`${selectedVehicle.make} ${selectedVehicle.model} ${selectedVehicle.year} - ${selectedVehicle.vin || "No VIN"}`}
                </p>
              </div>
              <Button
                variant="ghost"
                        ...
                        <div className="flex items-center gap-4 w-full md:w-auto flex-1">
                          <div className="flex-1 space-y-2">
                            ...
                            <div className="flex items-center flex-wrap gap-x-4 gap-y-1 text-sm">
                              ...
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${getConditionColor(quote.condition)}`}
                              >
                                {quote.condition}
                              </span>
                              <span>
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getConditionColor(selectedQuote.condition)}`}
                        >
                  ...
                  {selectedQuote.imageUrl && (
                    <div>
                      ...
                      <img
                        src={selectedQuote.imageUrl || "/placeholder.svg"}
                        alt="Part"
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Upload Inspection Images</label>
                        <input
                          type="file"
                          multiple
                          accept="image/*"
                          onChange={(e) =>
                            setReviewForm({
                              ...reviewForm,
                              inspectionImages: Array.from(e.target.files || []),
                            })
                          }
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-6 space-y-6">
                ...
                <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 border p-4 rounded-lg">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setAddQuoteForm({ ...addQuoteForm, vendorAddress: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500"
                ...
                <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 border p-4 rounded-lg">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Part Images</label>
                    <input
                      type="file"
                      multiple
                      accept="image/*"
